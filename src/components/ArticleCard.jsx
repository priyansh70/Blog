  ...
  return (
    <div className={`rounded-xl overflow-hidden shadow-[rgba(7,_65,_210,_0.1)_0px_9px_30px] ${className}`}>
      ...
      <div className="p-5">
        ...
        <p className='text-dark-light mt-3 text-sm md:text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, qui.</p>
        <div className="flex justify-between flex-nowrap items-center mt-6 ">
          <div className="flex items-center gap-x-2 md:gap-x-2.5">
            ...
            <div className="flex flex-col">
              <h4 className='font-bold italic text-dark-soft text-sm md:text-base'>Priyansh Patel</h4>
          ...
          <span className="text-dark-light italic text-sm font-bold md:text-base">02 May</span>
        </div>
      </div>
    </div>
  )
