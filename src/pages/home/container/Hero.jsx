  ...
  return (
    <section className='container mx-auto flex flex-col p-5 lg:flex-row'>
      <div className="mt-10 lg:w-1/2">
        ...
        <p className='text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Incidunt fugiat debitis tempore a at vel, voluptates culpa praesentium nulla voluptatum?</p>
        ...
        <div className="flex flex-col mt-4 lg:flex-row lg: lg:flex-nowrap lg:items-start lg:gap-x-4 lg:mt-7">
          <span className='text-dark-light font-semibold italic mt-2 lg:text-sm xl:text-base lg:mt-4'>Popular Tags:</span>
