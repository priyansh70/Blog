        ...
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              <input
                ...
                className="px-4 py-3 rounded-lg placeholder:text-dark-light w-full"
              />
          ...
          <div className="col-span-12 hidden md:block md:order-first mb-[70px] lg:col-span-6 lg:order-last">
            <div className="w-3/4 relative mx-auto">
              <div className="w-1/2 h-1/2 rounded-lg top-[10%] -right-[8%] bg-[#FC5A5A] absolute"/>
              <div className="w-1/2 h-1/2 rounded-lg -bottom-[10%] -left-[8%] bg-white opacity-[.06] absolute"/>              
              <div className="rounded-xl w-full bg-white p-3 z-10 relative">
                <img
                  src={images.CtaImage}
                  alt="title"
                ...
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm md:text-lg ">Our insurance plans offers are priced the same everywhere else.
                  </p>
                </div>
              </div>
            </div>
